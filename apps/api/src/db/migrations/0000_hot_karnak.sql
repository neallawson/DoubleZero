...
CREATE TYPE "public"."roster_role_type" AS ENUM('OWNER', 'HEAD_COACH', 'COACH', 'MANAGER', 'PLAYER', 'PARENT');--> statement-breakpoint
CREATE TYPE "public"."game_role_type" AS ENUM('STARTER', 'SUBSTITUTE', 'COACH', 'REFEREE', 'LINE_JUDGE');--> statement-breakpoint
CREATE TABLE "user" (
...
CREATE TABLE "person" (
	"id" serial PRIMARY KEY NOT NULL,
	"locker_room_id" integer NOT NULL,
	"user_id" integer,
...
CREATE TABLE "roster_role" (
	"id" serial PRIMARY KEY NOT NULL,
	"name" "roster_role_type" NOT NULL,
	"description" text,
	"is_active" boolean DEFAULT true NOT NULL,
	CONSTRAINT "roster_role_name_unique" UNIQUE("name")
);
--> statement-breakpoint
CREATE TABLE "team_roster" (
	...
	"roster_role_id" integer NOT NULL,
	"position_id" integer,
...
CREATE TABLE "game_role" (
	"id" serial PRIMARY KEY NOT NULL,
	"name" "game_role_type" NOT NULL,
	"description" text,
	"is_active" boolean DEFAULT true NOT NULL,
	CONSTRAINT "game_role_name_unique" UNIQUE("name")
);
--> statement-breakpoint
...
ALTER TABLE "person" ADD CONSTRAINT "person_locker_room_id_locker_room_id_fk" FOREIGN KEY ("locker_room_id") REFERENCES "public"."locker_room"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "locker_room" ADD CONSTRAINT "locker_room_owner_user_id_user_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "team" ADD CONSTRAINT "team_locker_room_id_locker_room_id_fk" FOREIGN KEY ("locker_room_id") REFERENCES "public"."locker_room"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "location" ADD CONSTRAINT "location_locker_room_id_locker_room_id_fk" FOREIGN KEY ("locker_room_id") REFERENCES "public"."locker_room"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "team_roster" ADD CONSTRAINT "team_roster_season_id_season_id_fk" FOREIGN KEY ("season_id") REFERENCES "public"."season"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "team_roster" ADD CONSTRAINT "team_roster_person_id_person_id_fk" FOREIGN KEY ("person_id") REFERENCES "public"."person"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "team_roster" ADD CONSTRAINT "team_roster_roster_role_id_roster_role_id_fk" FOREIGN KEY ("roster_role_id") REFERENCES "public"."roster_role"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "team_roster" ADD CONSTRAINT "team_roster_position_id_player_position_id_fk" FOREIGN KEY ("position_id") REFERENCES "public"."player_position"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "game" ADD CONSTRAINT "game_referee_person_id_person_id_fk" FOREIGN KEY ("referee_person_id") REFERENCES "public"."person"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "game_event" ADD CONSTRAINT "game_event_team_id_team_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."team"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "game_event" ADD CONSTRAINT "game_event_person_id_person_id_fk" FOREIGN KEY ("person_id") REFERENCES "public"."person"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "game_event" ADD CONSTRAINT "game_event_related_person_id_person_id_fk" FOREIGN KEY ("related_person_id") REFERENCES "public"."person"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "game_participant" ADD CONSTRAINT "game_participant_team_id_team_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."team"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "game_participant" ADD CONSTRAINT "game_participant_person_id_person_id_fk" FOREIGN KEY ("person_id") REFERENCES "public"."person"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "game_participant" ADD CONSTRAINT "game_participant_game_role_id_game_role_id_fk" FOREIGN KEY ("game_role_id") REFERENCES "public"."game_role"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
